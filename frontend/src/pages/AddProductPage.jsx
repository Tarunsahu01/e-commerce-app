...
export function AddProductPage() {
	...
	const [preview, setPreview] = useState(null); // Added for clean image preview
	...
	useEffect(() => {
		...
		// Cleanup function to free memory when image changes or component unmounts
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			// These keys must match your Spring Boot @RequestParam names exactly
